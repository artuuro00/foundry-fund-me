# A Makefile is a simple text file used in software development to automate the process of compiling and building executable programs or other files from the source code. It contains a set of rules that specify how the files depend on each other and the commands to compile or build them.
-include .env
